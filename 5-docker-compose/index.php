...
@keyframes loading {
    ...
    <body>
        ...
        <h1 style="width:400px; margin:auto auto;" data-text="PHP <?php echo $redis->incr("counter")." with MY_ENV_VAR2 =>".getenv("MY_ENV_VAR2");?>">PHP <?php echo $redis->incr("counter")." with MY_ENV_VAR2 =>".getenv("MY_ENV_VAR2");?></h1>
